...
One-page Next.js site: hero, about, and a 4-step membership flow
(details → OTP → plan → payment → membership ID).
...
## Edit
- `lib/site.ts` — committee name, contact details, membership plans & prices
